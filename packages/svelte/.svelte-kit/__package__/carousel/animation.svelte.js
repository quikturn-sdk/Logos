 ...
 */
export function createResizeObserver(callback, getElements) {
 ...
 */
export function createImageLoader(getListEl, onLoad) {
    const el = getListEl();
 ...
 */
export function createAnimationLoop(getTrack, getTargetVelocity, getSeqWidth, getSeqHeight, getIsHovered, getHoverSpeed, getIsVertical) {
    let rafId = null;
    let lastTs = null;
    let offset = 0;
    let velocity = 0;
