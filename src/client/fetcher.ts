 ...
 *
 * Given `"https://logos.getquikturn.io/github.com?token=abc"`, returns
 * `"github.com"`. Falls back to `"unknown"` if the path is empty.
 */
...
export async function browserFetch(
  ...
  // Build request headers — never include Authorization
